...
import { ArrowRight, Plus, ReceiptText, Camera, Repeat, ArrowRightLeft } from 'lucide-react-native';
          ...
          <View style={{ gap: theme.spacing.lg }}>
            ...
            <View style={{ flexDirection: 'row', gap: 12, marginTop: 16, marginBottom: 8 }}>
              ...
              >
                ...
                <Text variant="caption" style={{ fontWeight: '700', color: theme.colors.text, textAlign: 'center' }}>
                  {t('home_add_expense')}
                </Text>
              </Pressable>

              <Pressable
                onPress={() => router.push('/expense/add?mode=receipt')}
                style={({ pressed }) => ({
                  flex: 1,
                  flexDirection: 'column',
                  alignItems: 'center',
